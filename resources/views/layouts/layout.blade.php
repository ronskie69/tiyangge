...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased position-relative">
        ...
        {{-- @yield('content') --}}
        <div class="-d-flex sale_sale">
            <img src="{{ asset('images/ribbon_sale.png') }}" class="a1 img-fluid m-0 p-0">
            <img src="{{ asset('images/ribbon_sale.png') }}" class="a2 img-fluid m-0 p-0">
            <img src="{{ asset('images/ribbon_sale.png') }}" class="a3 img-fluid m-0 p-0">
        </div>
        ...
        <footer class="footer text-center text-lg-start">
                ...
                <div class="row mt-3">
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <a class="footer-brand" href="#">
                            <h2>
                                <i class="fa-solid fa-shopping-cart me-2"></i> <strong class="text-warning">TIYANG&nbsp;&bull;&nbsp;</strong>GE
                            </h2>
                        </a>
                    </div>
                  ...
                  <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    ...
                    <p><i class="fa-solid fa-phone me-3 text-secondary"></i> 87000</p>
                  </div>
                </div>
                </div>
            </div>
            <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
                © 2023
                <a class="text-reset fw-bold" href="https://ronskie69.github.io/">Nagonus</a>
            </div>
        </footer>
    </body>
    <script>        
        $('.btn-tabs').each(function(i, element){
            $(element).click(function(e){
                $('.btn-tabs').each(function(i, el){
